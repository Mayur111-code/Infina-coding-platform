...
const Settings = () => {
  ...
  const handleLogout = () => {
    if (window.confirm("Are you sure you want to logout?")) {
      // Only remove user, not app preferences
  ...
  const handleSupport = () => {
    window.open(
      "https://mail.google.com/mail/?view=cm&fs=1&to=mayurborse7440@gmail.com"
    );
  };
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-gray-600 text-lg font-medium">Loading your settings...</p>
      </div>
    );
  }
  ...
  // ------------------ MAIN UI ------------------
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 lg:p-8 mt-16 lg:mt-0">
      <div className="max-w-4xl mx-auto">
        {/* Header Section */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 lg:mb-8">
          <div className="mb-4 lg:mb-0">
          ...
          {user && (
            <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm shadow-lg px-4 py-2 lg:px-6 lg:py-3 rounded-xl lg:rounded-2xl">
              <img
                src={
                  user.userprofile && user.userprofile !== "null"
                    ? user.userprofile
              ...
              />
              <div>
                <span className="font-bold text-gray-800 capitalize text-sm lg:text-lg">
                  {user.username}
                </span>
                <p className="text-xs lg:text-sm text-gray-600">Account Settings</p>
              </div>
          ...
          <div className="lg:col-span-2 space-y-6 lg:space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {[
                  ...
                  { label: "Notifications", value: notifications, key: "notifications" },
                  { label: "Sound Effects", value: soundEffects, key: "soundEffects" },
                  { label: "Auto Save Progress", value: autoSave, key: "autoSave" },
                ].map((pref) => (
                  <div
                    key={pref.key}
                  ...
                  >
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        checked={pref.value}
                        onChange={(e) =>
                          handleToggle(pref.key, e.target.checked)
                        }
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-checked:bg-indigo-600 rounded-full relative after:content-[''] after:absolute after:w-5 after:h-5 after:bg-white after:rounded-full after:left-[2px] after:top-[2px] after:transition-all peer-checked:after:translate-x-full"></div>
                    </label>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  onClick={handleExportData}
                  className="p-4 bg-blue-50 text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-100 transition"
                >
                  📥 Export Data
                </button>
                <button
                  onClick={handleClearData}
                  className="p-4 bg-red-50 text-red-600 border border-red-200 rounded-lg hover:bg-red-100 transition"
                >
                  🗑️ Clear Data
                </button>
              </div>
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <button
                  onClick={handleSupport}
                  className="w-full p-3 bg-indigo-50 text-indigo-600 border border-indigo-200 rounded-lg hover:bg-indigo-100"
                >
                  📧 Contact Support
                </button>
                <button
                  onClick={handleFeedback}
                  className="w-full p-3 bg-green-50 text-green-600 border border-green-200 rounded-lg hover:bg-green-100"
                >
                  💡 Send Feedback
                </button>
              </div>
